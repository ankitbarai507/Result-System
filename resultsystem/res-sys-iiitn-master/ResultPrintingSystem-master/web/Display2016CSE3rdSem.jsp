<%-- 
    Document   : DisplayCSE3rdSem
    Created on : Feb 9, 2019, 1:52:49 PM
    Author     : ACER
--%>
        ...
        <tbody>
          <tr>
            ...
            if(con!=null)
            {
                ...
                String query="SELECT cse.*, cse_sem3.s1,cse_sem3.g1, cse_sem3.s2,cse_sem3.g2, cse_sem3.s3,cse_sem3.g3, cse_sem3.s4,cse_sem3.g4, cse_sem3.s5,cse_sem3.g5, cse_sem3.s6,cse_sem3.g6, cse_sem3.s7,cse_sem3.g7, cse_sem2.s1,cse_sem2.g1, cse_sem2.s2,cse_sem2.g2, cse_sem2.s3,cse_sem2.g3, cse_sem2.s4,cse_sem2.g4, cse_sem2.s5,cse_sem2.g5, cse_sem2.s6,cse_sem2.g6, cse_sem1.s1,cse_sem1.g1, cse_sem1.s2,cse_sem1.g2, cse_sem1.s3,cse_sem1.g3, cse_sem1.s4,cse_sem1.g4, cse_sem1.s5,cse_sem1.g5, cse_sem1.s6,cse_sem1.g6, cse_sem1.s7,cse_sem1.g7 FROM cse,cse_sem3,cse_sem2,cse_sem1 WHERE cse.enrollmentid=? AND cse_sem3.enrollmentid=? AND cse_sem2.enrollmentid=? AND cse_sem1.enrollmentid=?";
                ...
                CommonString s=new CommonString();Course c=new Course();
                derivative d=new derivative();
                int y=d.semToyear(semester);
