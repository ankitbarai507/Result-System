<%-- 
    Document   : DisplayCSE6thSem
    Created on : Feb 9, 2019, 5:08:52 PM
    Author     : ACER
--%>
          ...
          <tr>
               <%  int sem=Integer.parseInt(session.getAttribute("semester").toString());
                  String str=session.getAttribute("enrollmentid").toString();
                        ...
                        session_year+=(sem)/2;
                  %>
            <th><b>Session:</b>Jan-June <%=session_year %></th>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            if(con!=null)
            {
                String query="SELECT cse.*,cse_sem6.s1,cse_sem6.g1, cse_sem6.s2,cse_sem6.g2, cse_sem6.s3,cse_sem6.g3, cse_sem6.s4,cse_sem6.g4, cse_sem6.s5,cse_sem6.g5,cse_sem5.s1,cse_sem5.g1, cse_sem5.s2,cse_sem5.g2, cse_sem5.s3,cse_sem5.g3, cse_sem5.s4,cse_sem5.g4, cse_sem5.s5,cse_sem5.g5, cse_sem4.s1,cse_sem4.g1, cse_sem4.s2,cse_sem4.g2, cse_sem4.s3,cse_sem4.g3, cse_sem4.s4,cse_sem4.g4, cse_sem4.s5,cse_sem4.g5, cse_sem4.s6,cse_sem4.g6,cse_sem3.s1,cse_sem3.g1, cse_sem3.s2,cse_sem3.g2, cse_sem3.s3,cse_sem3.g3, cse_sem3.s4,cse_sem3.g4, cse_sem3.s5,cse_sem3.g5, cse_sem3.s6,cse_sem3.g6, cse_sem3.s7,cse_sem3.g7, cse_sem2.s1,cse_sem2.g1, cse_sem2.s2,cse_sem2.g2, cse_sem2.s3,cse_sem2.g3, cse_sem2.s4,cse_sem2.g4, cse_sem2.s5,cse_sem2.g5, cse_sem2.s6,cse_sem2.g6,cse_sem1.s1,cse_sem1.g1, cse_sem1.s2,cse_sem1.g2, cse_sem1.s3,cse_sem1.g3, cse_sem1.s4,cse_sem1.g4, cse_sem1.s5,cse_sem1.g5, cse_sem1.s6,cse_sem1.g6, cse_sem1.s7,cse_sem1.g7 FROM cse,cse_sem5,cse_sem4,cse_sem3,cse_sem2,cse_sem1 WHERE cse.enrollmentid=? AND cse_sem6.enrollmentid=? AND cse_sem5.enrollmentid=? AND cse_sem4.enrollmentid=? AND cse_sem3.enrollmentid=? AND cse_sem2.enrollmentid=? AND cse_sem1.enrollmentid=?";
