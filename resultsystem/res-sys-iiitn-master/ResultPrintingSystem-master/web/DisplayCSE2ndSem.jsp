<%-- 
    Document   : DisplayCSE2ndSem
    Created on : Feb 9, 2019, 3:10:04 PM
    Author     : ACER
--%>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            if(con!=null)
            {
                String query="SELECT cse.*, cse_sem2.s1,cse_sem2.g1, cse_sem2.s2,cse_sem2.g2, cse_sem2.s3,cse_sem2.g3, cse_sem2.s4,cse_sem2.g4, cse_sem2.s5,cse_sem2.g5, cse_sem2.s6,cse_sem2.g6,  cse_sem1.s1,cse_sem1.g1, cse_sem1.s2,cse_sem1.g2, cse_sem1.s3,cse_sem1.g3, cse_sem1.s4,cse_sem1.g4, cse_sem1.s5,cse_sem1.g5, cse_sem1.s6,cse_sem1.g6,cse_sem1.s7,cse_sem1.g7 FROM cse,cse_sem2,cse_sem1 WHERE cse.enrollmentid=? and cse_sem2.enrollmentid=? AND cse_sem1.enrollmentid=?";
