<%-- 
    Document   : DisplayECE1stSem
    Created on : Feb 9, 2019, 3:16:57 PM
    Author     : ACER
--%>
  ...
  <body style="padding: 50px 50px 50px 50px;">
    ...
    <div class="container-fluid">
      ...
      <% 
            ...
            if(con!=null)
            {
                String query="SELECT ece.*, ece_sem1.s1,ece_sem1.g1, ece_sem1.s2,ece_sem1.g2, ece_sem1.s3,ece_sem1.g3, ece_sem1.s4,ece_sem1.g4, ece_sem1.s5,ece_sem1.g5, ece_sem1.s6,ece_sem1.g6 FROM ece,ece_sem1 WHERE ece.enrollmentid=? AND ece_sem1.enrollmentid=?";
