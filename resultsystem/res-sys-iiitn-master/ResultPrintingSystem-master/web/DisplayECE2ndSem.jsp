<%-- 
    Document   : DisplayECE2ndSem
    Created on : Feb 9, 2019, 3:18:23 PM
    Author     : ACER
--%>
  ...
  <body style="padding: 50px 50px 50px 50px;">
    ...
    <div class="container-fluid">
      ...
      <% 
            ...
            if(con!=null)
            {
                String query="SELECT ece.*, ece_sem2.s1,ece_sem2.g1, ece_sem2.s2,ece_sem2.g2, ece_sem2.s3,ece_sem2.g3, ece_sem2.s4,ece_sem2.g4, ece_sem2.s5,ece_sem2.g5, ece_sem2.s6,ece_sem2.g6, ece_sem2.s7,ece_sem2.g7, ece_sem1.s1,ece_sem1.g1, ece_sem1.s2,ece_sem1.g2, ece_sem1.s3,ece_sem1.g3, ece_sem1.s4,ece_sem1.g4, ece_sem1.s5,ece_sem1.g5, ece_sem1.s6,ece_sem1.g6 FROM ece,ece_sem2,ece_sem1 WHERE ece.enrollmentid=? AND ece_sem2.enrollmentid=? AND ece_sem1.enrollmentid=?";
